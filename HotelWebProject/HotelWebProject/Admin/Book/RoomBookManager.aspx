<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true"
    CodeBehind="RoomBookManager.aspx.cs" Inherits="HotelWebProject.Admin.RoomBookManager" %>
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td> <%#Eval("CheckInTime","{0:yyyy-MM-dd hh:mm}") %> </td>
                                        <td> <%#Eval("CheckOutTime","{0:yyyy-MM-dd hh:mm}") %> </td>
                                        <td> <%#Eval("RoomCategory.CategoryName") %></td>
