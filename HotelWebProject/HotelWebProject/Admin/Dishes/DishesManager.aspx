<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Web.Master" AutoEventWireup="true"
    CodeBehind="DishesManager.aspx.cs" Inherits="HotelWebProject.Admin.DishesManager" %>
            ...
            <ItemTemplate>
                <div class="dishlist-item">
                    ...
                    <div class="dishlist-right">
                        ...
                        <div class="dishlist-txt">
                            <a class="text-primary" href='/Admin/Dishes/DishesPublish.aspx?Operation=1&dishId=<%#Eval("DishId") %>'>修改</a>&nbsp;&nbsp;
